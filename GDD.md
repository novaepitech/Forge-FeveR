...
Le jeu n'est pas une succession de niveaux, mais un flux continu et ininterrompu basé sur une boucle de 24 secondes. La transition entre les niveaux de difficulté est intégrée dans le gameplay sans aucun temps mort. Le jeu se termine précisément lorsque le joueur atteint et complète le niveau de difficulté maximal, marquant une fin de partie claire et incitant à recommencer pour améliorer le résultat.
...
#### 2.7. Fin de Partie et Rejouabilité

- **Condition de Fin :** Le jeu se termine immédiatement lorsque le joueur atteint et complète une boucle au niveau de difficulté maximal (le palier le plus élevé). Cela survient après une promotion réussie vers ce niveau, suivi d'une boucle finale de 24 secondes où le joueur doit performer.
- **Séquence de Fin :**
  - À la fin de cette boucle maximale, un écran de résultats s'affiche, mettant en avant l'épée forgée (basée sur le score et les paliers atteints), le score final, les multiplicateurs, et des comparaisons avec les meilleurs scores personnels ou leaderboards.
  - Une animation dramatique (explosion de la forge, révélation épique de l'épée, musique culminante) marque la victoire et la fin de la partie.
- **Rejouabilité Intégrée :** Après l'écran de résultats, le joueur est invité à "relancer la forge" pour tenter d'obtenir une épée de meilleure qualité, un score plus élevé, ou une performance plus parfaite. Cela encourage des runs multiples, en alignement avec l'aspect roguelite, sans permettre de prolonger indéfiniment une partie au niveau maximal pour éviter la fatigue et maintenir la tension.
...
- **Feedback de Fin :** Sons et visuels épiques pour la complétion du niveau maximal, renforçant le sentiment d'accomplissement.
...
### 5. Scope pour la Game Jam (MVP - v1.5)
...
- Visuels et sons de base pour toutes les mécaniques, incluant la séquence de fin de partie.
- Au moins 2 Paliers de qualité, chacun avec 3 Niveaux d'épée (total 6 apparences), incluant au moins un checkpoint et un niveau maximal pour tester la fin de jeu.
- Pas de menus complexes, une expérience jouable de bout en bout, avec invitation à relancer après la fin.
